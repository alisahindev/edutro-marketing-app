                ...
                <Row className="justify-content-center">
                  <Col lg={12} className="text-center">
                    <div className="page-next-level">
                      <h4 className="title">İletişime Geç</h4>
            ...
            <Row>
              <Col md={4}>
                <div className="contact-detail text-center">
                  ...
                  <div className="content mt-3">
                    <h4 className="title font-weight-bold">Telefon</h4>
              ...
              <Col md={4} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="contact-detail text-center">
                  ...
                  <div className="content mt-3">
                    <h4 className="title font-weight-bold">E-Posta</h4>
                    <p className="text-muted"></p>
                    <Link
              ...
              <Col md={4} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="contact-detail text-center">
                  ...
                  <div className="content mt-3">
                    <h4 className="title font-weight-bold">Lokasyon</h4>
              ...
              >
                <div className="pt-5 pb-5 p-4 bg-light shadow rounded">
                  ...
                  <div className="custom-form mt-4">
                    ...
                    >
                      İletişim bilgileri başarıyla gönderildi.
                    </Alert>
                    <form
                      method="post"
