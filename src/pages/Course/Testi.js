          ...
          <div className="customer-testi text-left">
            ...
            <div className="content overflow-hidden d-block p-3 shadow rounded bg-white">
              ...
              <h6 className="text-primary">
                - {items[i].title} <small className="text-muted">Student</small>
              </h6>
            </div>
          </div>
        </div>
        ...
        <section className="section">
              ...
              <Col className="text-center">
                <div className="section-title mb-4 pb-2">
                  <h4 className="title mb-4">
                    Eğitime Katılanların Edutro Hakkında Düşünceleri
                  </h4>
                </div>
              </Col>
            </Row>
          ...
          <div className="container mt-100 mt-60">
            <Row className="justify-content-center">
              <Col className="text-center">
                <div className="section-title mb-4 pb-2">
                  <h4 className="title mb-4">E-Mail Bültenimize Kaydolun</h4>
                  <p className="text-muted para-desc mx-auto mb-0">
                    Bültenimize Abone Olun ve{" "}
                    <span className="text-primary font-weight-bold">
                      İndirimli Eğitimlerden ve Kampanyalardan
                    </span>{" "}
